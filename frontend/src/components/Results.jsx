...
export default function Results({ results, design, onBack, onEditSamples, session, annMap, annDetails, sampleLabels = {}, onAnnotate, onGseaRunsChange, initialGseaRuns }) {
